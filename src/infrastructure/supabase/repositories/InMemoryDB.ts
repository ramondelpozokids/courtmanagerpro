...
import { RMB_BASKETBALL_KIT_2627 } from "@/data/rmb-basketball-kit-2627";
...
/** Solo kit oficial baloncesto 26/27 (10 piezas tienda). */
export const initialInventory: any[] = RMB_BASKETBALL_KIT_2627.map((item) => ({
  ...item,
...
export const initialRequests: any[] = [
  {
    ...
    itemId: "i1",
    itemName: "Camiseta Técnica Hombre Pro adidas Entrenamiento 26/27 Verde",
    quantity: 2,
    size: "M",
    status: "PENDING",
  ...
  },
  {
    ...
    itemId: "trn1",
    itemName: "Chándal Hombre adidas Entrenamiento 26/27 Verde",
    quantity: 1,
    size: "52",
    status: "APPROVED",
