...
function atmPacking(prefix: string) {
  return [
    {
      id: `${prefix}a`,
      itemName: 'Camiseta Match Hombre 1ª Equipación 26/27',
...
/** Próximos partidos oficiales (desde sept 2026) — no amistosos de pretemporada ya jugados. */
export const atmTrips = [
  {
    id: 't1',
    destination: 'Riyadh Air Metropolitano',
    opponent: 'Osasuna',
    departureDate: '2026-09-16',
    returnDate: '2026-09-16',
    status: 'planificado',
    packingList: atmPacking('tp1'),
    notes: 'LaLiga J6 · 16 sep 19:00 · local · calendario oficial Atleti',
  },
  {
    id: 't2',
    destination: 'Riyadh Air Metropolitano',
    ...
    status: 'planificado',
    packingList: atmPacking('tp2'),
    notes: 'LaLiga J7 · derbi · 20 sep 16:15 · local · calendario oficial Atleti',
  },
  {
    id: 't3',
    destination: 'Estadio de Mendizorroza',
    opponent: 'Alavés',
    departureDate: '2026-10-09',
    returnDate: '2026-10-11',
    status: 'planificado',
    packingList: atmPacking('tp3'),
    notes: 'LaLiga J8 · 10 oct 16:15 · visitante · calendario oficial Atleti',
  },
  {
    id: 't4',
    destination: 'Riyadh Air Metropolitano',
    ...
    status: 'planificado',
    packingList: atmPacking('tp4'),
    notes: 'UEFA Champions League J2 · 13 oct 21:00 · local · calendario oficial Atleti',
  },
  {
    id: 't5',
    destination: 'RCDE Stadium',
    opponent: 'Espanyol',
    departureDate: '2026-10-17',
    returnDate: '2026-10-19',
    status: 'planificado',
    packingList: atmPacking('tp5'),
    notes: 'LaLiga J9 · 17/18 oct · visitante · calendario oficial Atleti',
  },
];
