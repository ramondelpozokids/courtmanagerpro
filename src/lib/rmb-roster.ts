...
function mergeLivePlayerOntoPack(packP: Player, liveP: Player): Player {
  return {
    ...
    notes: liveP.notes ?? packP.notes,
    jersey_name: liveP.jersey_name || packP.jersey_name,
    contract_end: liveP.contract_end ?? packP.contract_end,
    ...
    suit_size: liveP.suit_size ?? packP.suit_size,
    hat_size: liveP.hat_size ?? packP.hat_size,
